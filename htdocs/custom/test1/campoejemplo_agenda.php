...
/**
 *  \file       campoejemplo_agenda.php
 *  \ingroup    test1
 *  \brief      Tab of events on CampoEjemplo
 */
...
$hookmanager->initHooks(array('campoejemploagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnCampoEjemplo"), '', '');
