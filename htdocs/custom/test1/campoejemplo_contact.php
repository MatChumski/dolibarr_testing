...
/**
 *  \file       campoejemplo_contact.php
 *  \ingroup    test1
 *  \brief      Tab for contacts linked to CampoEjemplo
 */
...
$hookmanager->initHooks(array('campoejemplocontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->test1->campoejemplo->write;
...
$title = $langs->trans('CampoEjemplo')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
