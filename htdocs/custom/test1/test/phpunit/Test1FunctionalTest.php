...
/**
 * \file    test/phpunit/Test1FunctionalTest.php
 * \ingroup test1
 ...
 * @package Testtest1
 */
class Test1FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/test1/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('test1/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/test1/admin/about.php');
		$this->authenticate();
		return $this->assertContains('test1/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('test1widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTest1_Test1Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTest1_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
