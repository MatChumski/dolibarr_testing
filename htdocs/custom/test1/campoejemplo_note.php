...
/**
 *  \file       campoejemplo_note.php
 *  \ingroup    test1
 *  \brief      Tab for notes on CampoEjemplo
 */
...
$hookmanager->initHooks(array('campoejemplonote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->test1->campoejemplo->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('CampoEjemplo'), $help_url);
