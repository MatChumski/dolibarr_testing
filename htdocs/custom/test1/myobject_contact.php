...
/**
 *  \file       test1/myobject_contact.php
 *  \ingroup    test1
...
dol_include_once('/test1/class/myobject.class.php');
dol_include_once('/test1/lib/test1_myobject.lib.php');
...
$permission = $user->rights->test1->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/test1/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
