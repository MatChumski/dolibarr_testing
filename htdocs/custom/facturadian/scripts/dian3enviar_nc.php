...
WHERE (NOT extra.envio OR extra.envio is NULL) AND fac.type = '2' AND LEFT(fac.ref,1) <> '(' AND (extra.isvalid <> 'true' OR extra.isvalid is NULL) AND fac.ref LIKE '".DOCUMENT."%' ORDER BY fac.ref
LIMIT ".LIMITE; 
...
while($row = $result->fetch_array(MYSQLI_ASSOC)) {
	...
	if($validaciones) {
		...
		echo "<br />===> Documento NC: (".$prefijo.$numero.") enviando a la Dian,  ";
		...
		$dolibarr->grabardatos($cadenaf);
		echo "<br />===> Error en la NOTA CREDITO: ".$prefijo.$numero."\n";
