...
if ($action == 'enviar')
{
	...
	print "Documento: ".$_POST['documento'].",";
	print "etapa: ".$_POST['etapa'].",";
	print "invoice: ".$_POST['invoice'].",";
	print "cantidad: ".$_POST['cantidad']."<br />";
			...
			if($db->num_rows($resql) > 0) {
				...
				if ($resqlconfig) {
					if($db->num_rows($resqlconfig) > 0) {
						...
						if($_POST['etapa'] == 'todas') {
							$ejecutar = "php scripts/dian3enviar_".$_POST['documento'].".php ".$objp->username." ".$objp->password." ".$_POST['cantidad']." ".$_POST['invoice']." ".$objpconfig->config;
							//$ejecutar = "php api/enviar_".$_POST['documento'].".php ".$objp->username." ".$objp->password." ".$_POST['cantidad']." ".$_POST['invoice']." ".$objpconfig->config;
							...
							//Actualiza
							$ejecutar2= "echo 'php scripts/update.php ".$objp->username." ".$objp->password." ".$objpconfig->config."' | at now + ".++$tiempo." minutes";
							$respuesta2 = shell_exec($ejecutar2);

							//Eventos
							$ejecutar7= "echo 'php scripts/eventos.php ".$objp->username." ".$objp->password." ".$objpconfig->config."' | at now + ".++$tiempo." minutes";
							$respuesta7 = shell_exec($ejecutar7);

						}
						if($_POST['etapa'] == 'email') {
										
							//Cliente
							$ejecutar5= "php scripts/dian3cliente.php ".$objp->username." ".$objp->password." ".$_POST['ambiente']." ".$_POST['invoice']." ".$objpconfig->config;
							$respuesta5 = shell_exec($ejecutar5);
							print "<br /><br />".$respuesta5;
							...
							$tiempo=1;
							//Actualiza
							$ejecutar6= "echo 'php scripts/update.php ".$objp->username." ".$objp->password." ".$objpconfig->config."' | at now + ".++$tiempo." minutes";
...
{
	print load_fiche_titre($langs->trans("Actualizando manualmente Dolibarr", $langs->transnoentitiesnoconv("cron")));
			...
			if($db->num_rows($resql) > 0) {
				...
				if ($resqlconfig) {
					if($db->num_rows($resqlconfig) > 0) {
						...
						//Actualiza
						$ejecutar2= "php scripts/update.php ".$objp->username." ".$objp->password." ".$objpconfig->config;
						$respuesta2 = shell_exec($ejecutar2);
						print "<br />Actualizando datos desde la Dian...(<font color='green'>Ok</font>)";

						//Eventos
						$ejecutar7= "php scripts/eventos.php ".$objp->username." ".$objp->password." ".$objpconfig->config;
						$respuesta7 = shell_exec($ejecutar7);
						print "<br />Actualizando datos desde el Cliente...(<font color='green'>Ok</font>)";

						print "<br /><br /><font color='blue'><h3>Consulta tu listado de factura en Dolibarr para ver los resultados...</h3></font>";
