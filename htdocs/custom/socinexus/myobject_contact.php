...
/**
 *  \file       socinexus/myobject_contact.php
 *  \ingroup    socinexus
...
dol_include_once('/socinexus/class/myobject.class.php');
dol_include_once('/socinexus/lib/socinexus_myobject.lib.php');
...
$permission = $user->rights->socinexus->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/socinexus/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
