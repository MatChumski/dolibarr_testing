        ...
        <form action="historialgarantia.php" method="POST">
            ...
            <table class="table" style="text-align: center" id="data">
            	...
            	<tbody><!-- Cuerpo de la Tabla Impresion de datos-->
                    ...
                    $query3 = "SELECT * FROM llx_garantia WHERE status = 1";
                            ...
                            if ($result != NULL) {
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    if($date!= NULL){echo '<tr style = "background-color:#58D3F7;">';}//Azul
                                        ...
                                        <td><?php echo $row['date_reception']; //fecha en que se recibio?></td>
                                        <td><?php echo utf8_encode($fourn['nom']); // se imprime el nombre del proveedor?></td>
                                        <td><?php if($date== NULL){echo $dias; echo" días";}else{ echo"Recibido";} //nombre del proveedor?></td>
                                         -->
