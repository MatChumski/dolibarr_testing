...
$marca='';
$project='';
// Se obtiene el ID del envio a garantia
if  (isset($_GET['id'])) {
    $id = $_GET['id'];
}
    ...
    <body>
      ...
      while($row = mysqli_fetch_assoc($result)) {
        if($row['rowid']==$id){
            ...
            <?php echo "<b>Consecutivo: ".$row['ref']."</b>"; $consecutivo=$row['ref']; //Consecutivo de Garantia?><br></br>
            <?php echo "<b>Fecha de Envio: </b>".$row['date_send']; $fechaenvio=$row['date_send']; //Fecha de envio?><br></br>
            ...
            <tbody><!-- Cuerpo de la Tabla Impresion de datos-->
                ...
                <td VALIGN="TOP">
                    ...
                    <tbody>
                        ...
                        $query2 = "SELECT * FROM llx_revision WHERE fk_equipment_history = $idh AND status=1 AND date_send<'$fechaenvio' AND date_send>'$fecharecepcion'";
...
$mipdf->stream("Garantia-$ref-Con-$consecutivo.pdf", array("Attachment" => false));
